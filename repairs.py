...
class Repairs(customtkinter.CTkToplevel):
    ...
    def create_widgets(self):
        ...
        self.FillComboBox1()
        self.LoadRepairsForPCButton = customtkinter.CTkButton(master=self.LoadDataFrame, text="Загрузить ремонты", command=lambda: self.LoadData())
        self.LoadRepairsForPCButton.grid(row=1, column=2, pady=5, padx=10, sticky="ew")
